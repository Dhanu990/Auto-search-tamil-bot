...
BOT_TOKEN = environ.get('BOT_TOKEN', "6716617168:AAE4P1o6ugWZbUaoX6IAB5-CzmlokUM500A")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001632709359').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://DHANUSH:DHANUSH@cluster0.2dppahj.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "DHANUSH")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
VERIFY = bool(environ.get('VERIFY', False))
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'onepagelink.in')
SHORTLINK_API = environ.get('SHORTLINK_API', 'afdf1268f928fdcd09a82d54f27f8e6530e97f98')
SECOND_SHORTLINK_URL = environ.get('SECOND_SHORTLINK_URL', 'onepagelink.in')
SECOND_SHORTLINK_API = environ.get('SECOND_SHORTLINK_API', 'afdf1268f928fdcd09a82d54f27f8e6530e97f98')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002041057749'))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002113639677')).split()]
